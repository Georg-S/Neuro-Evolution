...
public:
	...
	int getHiddenNeuronCountOfSpecificGenotype(int genotypeIndex);
	int getCountOfEnabledLinksOfSpecificGenotype(int genotypeIndex);

	void setExzessFactor(double exzessFactor);
	void setDisjointFactor(double disjointFactor);
	void setWeightFactor(double weightFactor);
	void setCompatibilityDistanceThreshold(double compatibilityDistanceThreshold);
	void setGenerationsNoImprovementAllowed(int generationsNoImprovementAllowed);
	void setSpeciesRoughValue(int speciesRoughValue);
	...
	void setMutateLinkProbability(double mutateLinkProbability);
	void setNewLinkWeightProbability(double newLinkWeightProbability);
...
//NEAT-Parameters
	...
	int generationsNoImprovementAllowed = 15;

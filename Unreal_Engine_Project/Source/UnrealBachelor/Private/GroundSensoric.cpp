...
#include "../Public/GroundSensoric.h"
...
GroundSensoric::~GroundSensoric()
{
}

vector<double> GroundSensoric::getDataFromSensors(const FVector &forwardVector, const FVector &actorLocation, UWorld* world)
{
